...
- The frontend has public read-only monitoring, state displays, Privy wallet connection, RPC failure handling, and privacy-correct public data boundaries. Wallet connection does not request signatures or transactions.
